package us.forestbukkit.kitpvp.utils.scoreboard;
...
public class BoardManager {
	...
	public BoardManager(BoardAdapter adapter, int updateTick) {
		...
		Bukkit.getPluginManager().registerEvents(new BoardListener(this), KitPvP.getInstance());
		Bukkit.getScheduler().runTaskTimer(KitPvP.getInstance(), this::sendScoreboard, 0, updateTick);
	}
